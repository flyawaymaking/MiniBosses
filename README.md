...
Если установлен плагин **[CoinsEngine](https://github.com/CryptoMorin/CoinsEngine)**, MiniBosses может использовать игровую валюту для покупки боссов:
...
- ✅ **Paper** 1.21.8 - полная поддержка
- ✅ **WorldGuard** - интеграция с регионами
- ✅ **EssentialsX** - проверка AFK игроков
